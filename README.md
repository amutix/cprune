...
- `est. saved last turn` prices the actual prompt-token delta captured for the model call that produced the last response, using real billing data when available or clearly labeled assumed pricing otherwise.
